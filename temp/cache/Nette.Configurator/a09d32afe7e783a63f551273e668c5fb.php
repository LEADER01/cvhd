<?php
// source: C:\xampp\htdocs\cvhd\app/config/config.neon 
// source: C:\xampp\htdocs\cvhd\app/config/config.local.neon 
 ...
 * @property App\Model\ImageStorage $imageStorage
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\imagestorage' => array('imageStorage'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\xampp\\htdocs\\cvhd\\app',
			'wwwDir' => 'C:\\xampp\\htdocs\\cvhd\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\xampp\\htdocs\\cvhd\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\xampp\\htdocs\\cvhd\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new App\Model\ImageStorage('C:\\xampp\\htdocs\\cvhd\\www/images');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\xampp\\htdocs\\cvhd\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=d39930_cvhd', 'root', NULL, array('lazy' => TRUE));
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\xampp\\htdocs\\cvhd\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\xampp\\htdocs\\cvhd\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\xampp\\htdocs\\cvhd\\app/../temp/cache', $this->getService('nette.cacheJournal'));
