...
list($_b, $_g, $_l) = $template->initialize('5290930759', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb04b2d5b0e2_content')) { function _lb04b2d5b0e2_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb9e7093f433_title')) { function _lb9e7093f433_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb07759ed523_scripts')) { function _lb07759ed523_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb60ff6ed52c_head')) { function _lb60ff6ed52c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
